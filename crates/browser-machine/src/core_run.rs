...
const DEFAULT_MAXIMUM_CYCLES: u64 = 1_000_000;
const DEFAULT_MAXIMUM_BLOCKS: u32 = 16_384;
...
impl Default for SlicePolicy {
    fn default() -> Self {
        Self {
            ...
            maximum_cycles: DEFAULT_MAXIMUM_CYCLES,
...
impl SlicePolicy {
    ...
    pub const fn is_valid(self) -> bool {
        self.maximum_cycles != 0
            && self.maximum_cycles <= u32::MAX as u64
