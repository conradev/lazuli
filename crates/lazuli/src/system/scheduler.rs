...
/// Number of CPU cycles in one architected Gekko time-base/decrementer tick.
pub const CPU_CYCLES_PER_TIME_BASE_TICK: u64 = 12;
...
impl Scheduler {
    ...
    pub fn elapsed_time_base(&self) -> u64 {
        self.observed_elapsed() / CPU_CYCLES_PER_TIME_BASE_TICK
    }
}
