...
function luigisMansionGuestGame({
  ...
  return {
    ...
    inputGate: {
      healthAddress: hex32(PLAYER + 0xfc),
      health: 100,
      state1042Address: hex32(PLAYER + 0x1042),
      state1042: 0,
      state1058Address: hex32(PLAYER + 0x1058),
      state1058: 0,
      timer105cAddress: hex32(PLAYER + 0x105c),
      timer105c: 0,
      state106cAddress: hex32(PLAYER + 0x106c),
      state106c: 0,
      open: true,
    },
    expectedInputSource: hex32(PAD),
    inputGateCoherent: true,
    inputPipelineReady: true,
    controllerAcceptingPad: true,
